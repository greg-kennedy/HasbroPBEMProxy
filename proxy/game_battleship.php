...
// GAME HANDLER - EMAIL BATTLESHIP
// Header info is mostly 0
//  getting more info would require picking apart the .EFB file

function handle_battleship($timestamp, $header, $custom, $payload, $players)
{
  _d("-- BATTLESHIP FILE --");
  ...
  $filename = sprintf("battleship_%010d_t%02d_%s_vs_%s.bsem",
    $game_start,
    $turn_number,
...
$games[ 0x00003216 ] = 'handle_battleship';
